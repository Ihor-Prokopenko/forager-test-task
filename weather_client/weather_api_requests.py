...
class BaseWeatherAPIRequest(object):
    ...
    Attributes:
        ...
        params (dict): The parameters for the API.
    ...
    def _encode_query_params(self, query_params: dict = None) -> str:
        """
    ...
    def _build_url(self, path: str = '', query_params: dict = None) -> str:
        """
    ...
    def _make_request(self, path: str = '', query_params: dict = None) -> requests.Response:
        """
